...
<script>
  export default {
    props: {
      ...
      initialRecipeSeasoningCount: {
        type: String,
        default: "",
      },
      initialRecipeStep1Count: {
        type: String,
        default: "",
      },
      initialRecipeStep2Count: {
        type: String,
        default: "",
      },
      initialRecipeStep3Count: {
        type: String,
        default: "",
      },
      initialRecipeStep4Count: {
        type: String,
        default: "",
      },
      initialRecipeStep5Count: {
        type: String,
        default: "",
      },
      initialRecipeStep6Count: {
        type: String,
        default: "",
      },
      initialCookingPointCount: {
        type: String,
        default: "",
      },
    },
